...
var cam = require('nsc')( canvas, { position: [ 0.0, 0.0, -7.0 ], damping: 0.1 } );
var cga = require('cga');
var lgp = require('lgp');
...
var QuadSubdivideOperator = require('mda').QuadSubdivideOperator;
...
window.addEventListener( 'keydown', function( event ) {
  if( keyPressed( 'S' ) ) {
    lgp.imageWriter( 'mesh-triangulation.png', canvas.toDataURL('image/png') );
  }
}, false );
